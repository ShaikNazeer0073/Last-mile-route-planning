    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header bg-gradient">
                <h5 class="mb-0 text-white"><i class="fa-solid fa-pen me-2"></i>Edit Product</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('products.update', $product) }}" method="POST">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="url" name="image" class="form-control" required value="{{ old('image', $product->image) }}">
                        </div>
                    </div>
                    <div class="mt-4">
